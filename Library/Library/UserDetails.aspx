                ...
                <div class="row">
                    <div class="span4">
                        ...
                        <div class="FileUploadContainer">
                            ...
                            <asp:LinkButton ID="UploadProfileImage" OnClick="UploadProfileImage_OnClick" Text="Save" runat="server" />
                        </div>
                    </div>
                    <div class="span6">
                        <div class="well">
                ...
                <div class="row">
                    ...
                    <div class="span4">
                        <div class="well form-horizontal rightAlign">
                            ...
                            <div class="user-item">
                                <asp:Label runat="server" CssClass="InfoLabel" Text="Reason: "></asp:Label>
                                <asp:TextBox runat="server" ID="ReasonTb" Text="<%#: BindItem.Reason.Name %>"></asp:TextBox>
                            </div>
                        </div>
                        <div class="well rightAlign">
                            ...
                            <div class="user-item">
                                <asp:Label runat="server" CssClass="InfoLabel" Text="Country: "></asp:Label>
                                <asp:TextBox runat="server" ID="CountryTb" Text="<%#: BindItem.Country.Name %>"></asp:TextBox>
                            </div>
                            <div class="user-item">
                                <asp:Label runat="server" CssClass="InfoLabel" Text="City: "></asp:Label>
                                <asp:TextBox runat="server" ID="CityTb" Text="<%#: BindItem.City.Name %>"></asp:TextBox>
                            </div>
                            <div class="user-item">
                                <asp:Label runat="server" CssClass="InfoLabel" Text="Education: "></asp:Label>
                                <asp:TextBox runat="server" ID="EducationTb" Text="<%#: BindItem.Education.Name %>"></asp:TextBox>
                            </div>
                        </div>
                        <div>
