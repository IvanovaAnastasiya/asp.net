...
<asp:Content ID="AdminUserContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row-fluid">
        ...
        <div class="form-horizontal span4">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    <%--<asp:RequiredFieldValidator runat="server" ControlToValidate="DropDownListLookingFor"
                        CssClass="text-error" ErrorMessage="The Looking for field is required." ID="RequiredFieldValidator1" />--%>
                </div>
            </div>
            ...
            <%-- <div class="control-group">
                <asp:Label runat="server" AssociatedControlID="ChangeUserPassword" CssClass="control-label">Password</asp:Label>
                <div class="controls">
                    <asp:UpdatePanel runat="server" >
                         <ContentTemplate>
                             <asp:Button ID="SendChangePasswordEmailButton" runat="server" OnClick="SendChangePasswordEmailButton_Click" Text="SendChangeUserPassword"
                         </ContentTemplate>
                    </asp:UpdatePanel>                   
        ...
        <div class="form-horizontal span4">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    <%--<asp:CompareValidator runat="server" Type="Date" Operator="DataTypeCheck" ID="CompareValidatorBirthDate" 
                        ControlToValidate="TextBoxBirthDate" ForeColor="Red"></asp:CompareValidator>--%>
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <asp:DropDownList runat="server" ID="DropDownListCountry"></asp:DropDownList>
